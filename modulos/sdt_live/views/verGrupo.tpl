<div class="bloque">
	<a href="{$_layoutParams.root}sdt_live/indexGrupo"><button type="button" class="btn btn-{$_layoutParams.btn_return}">Regresar</button></a>
</div>
              ...
              <td class="text-right">
                <div class="btn-group">
                  <button type="button" class="btn btn-default" >
                    <a href="{$_layoutParams.root}sdt_live/crearTareaModelo/{$dato.id_grupo}/{$dato.id_tarea}">
