...
<div class="bloque">
	...
	<div class="row">
		<div class="col-md-12">
			<label for="tipo_campana">Clasificación</label>
			  	...
			  	<tbody>
			  		{if isset($datos)}
						{foreach item=tipo from=$datos}
					  		<tr id="tr_{$tipo.id_u_clasificacion}">
					  			<td class="col-md-10">
					  				<input type="text" class="form-control" id="tipo_campana_{$tipo.id_u_clasificacion}" value="{$tipo.nombre_clasificacion}" name="nombre_campana"/>
					  			</td>
					  			<td class="col-md-2">
					  				<input type="checkbox" id="checktipo_{$tipo.id_u_clasificacion}" value="{$tipo.nombre_clasificacion}" name="nombre_campana"/>
					  			</td>
					  		</tr>
				  		{/foreach}
				  	{/if}
